...
/// <summary>
/// Based on version 2.0.0 of the Super Character Controller
/// </summary>
[RequireComponent(typeof(ControlComponent))]
public class SCCComponent : MonoBehaviour
{
    public event Action<float> SuperUpdateEvent = delegate { };
    ...
    public struct Ground
    {
        ...
        public Ground(RaycastHit hit, RaycastHit nearHit, RaycastHit farHit, RaycastHit secondaryHit, SuperCollisionType superCollisionType, Transform hitTransform) : this()
        {
            this.hit = hit;
    ...
    void SingleUpdate()
    {
        ...
        SuperUpdateEvent.Invoke(deltaTime);
    ...
    {
        public SuperGround(LayerMask walkable, SCCComponent controller)
        {
        ...
        private SCCComponent controller;
